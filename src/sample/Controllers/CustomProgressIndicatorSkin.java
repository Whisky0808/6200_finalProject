...
public class CustomProgressIndicatorSkin extends BehaviorSkinBase<CustomProgressIndicator, BehaviorBase<CustomProgressIndicator>> {
    ...
    private ObjectProperty<Paint> progressColor = new StyleableObjectProperty<Paint>(null) {
        ...
        @Override public Object getBean() {
            return CustomProgressIndicatorSkin.this;
        }
        ...
        @Override public CssMetaData<CustomProgressIndicator,Paint> getCssMetaData() {
    ...
    private IntegerProperty indeterminateSegmentCount = new StyleableIntegerProperty(8) {
        ...
        @Override public CssMetaData<CustomProgressIndicator,Number> getCssMetaData() {
    ...
    private final BooleanProperty spinEnabled = new StyleableBooleanProperty(false) {
        ...
        @Override public CssMetaData<CustomProgressIndicator,Boolean> getCssMetaData() {
            return SPIN_ENABLED;
        }
    ...
    private CustomProgressIndicator control;
    ...
    public CustomProgressIndicatorSkin(CustomProgressIndicator control) {
        super(control, new BehaviorBase<CustomProgressIndicator>(control, Collections.emptyList()));
    ...
    public CustomProgressIndicatorSkin(CustomProgressIndicator control,TodoItem item) {
        super(control, new BehaviorBase<CustomProgressIndicator>(control, Collections.emptyList()));
        this.item=item;
        this.control = control;
        // register listeners
    ...
    protected void updateAnimation() {
        CustomProgressIndicator control = getSkinnable();
    ...
    private class DeterminateIndicator extends Region {
        ...
        public DeterminateIndicator(CustomProgressIndicator control, CustomProgressIndicatorSkin s, Paint fillOverride) {
            ...
            text = new Text((control.getProgress() >= 1) ? ("Passed") : ("Upcomming"));
        ...
        private void updateProgress(double progress) {
            ...
            text.setText((progress >= 1) ? ("Passed") : ("Upcomming"));
    ...
    private static final CssMetaData<CustomProgressIndicator,Paint> PROGRESS_COLOR =
            new CssMetaData<CustomProgressIndicator,Paint>("-fx-progress-color",
                    PaintConverter.getInstance(), null) {

                @Override
                public boolean isSettable(CustomProgressIndicator n) {
                    final CustomProgressIndicatorSkin skin = (CustomProgressIndicatorSkin) n.getSkin();
                    return skin.progressColor == null ||
                            !skin.progressColor.isBound();
                }

                @Override
                public StyleableProperty<Paint> getStyleableProperty(CustomProgressIndicator n) {
                    final CustomProgressIndicatorSkin skin = (CustomProgressIndicatorSkin) n.getSkin();
                    return (StyleableProperty<Paint>)(WritableValue<Paint>)skin.progressColor;
                }
            };
    private static final CssMetaData<CustomProgressIndicator,Number> INDETERMINATE_SEGMENT_COUNT =
            new CssMetaData<CustomProgressIndicator,Number>("-fx-indeterminate-segment-count",
                    SizeConverter.getInstance(), 8) {

                @Override public boolean isSettable(CustomProgressIndicator n) {
                    final CustomProgressIndicatorSkin skin = (CustomProgressIndicatorSkin) n.getSkin();
                    return skin.indeterminateSegmentCount == null ||
                            !skin.indeterminateSegmentCount.isBound();
                }

                @Override public StyleableProperty<Number> getStyleableProperty(CustomProgressIndicator n) {
                    final CustomProgressIndicatorSkin skin = (CustomProgressIndicatorSkin) n.getSkin();
                    return (StyleableProperty<Number>)(WritableValue<Number>)skin.indeterminateSegmentCount;
                }
            };
    private static final CssMetaData<CustomProgressIndicator,Boolean> SPIN_ENABLED =
            new CssMetaData<CustomProgressIndicator,Boolean>("-fx-spin-enabled", BooleanConverter.getInstance(), Boolean.FALSE) {

                @Override public boolean isSettable(CustomProgressIndicator node) {
                    final CustomProgressIndicatorSkin skin = (CustomProgressIndicatorSkin) node.getSkin();
                    return skin.spinEnabled == null || !skin.spinEnabled.isBound();
                }

                @Override public StyleableProperty<Boolean> getStyleableProperty(CustomProgressIndicator node) {
                    final CustomProgressIndicatorSkin skin = (CustomProgressIndicatorSkin) node.getSkin();
